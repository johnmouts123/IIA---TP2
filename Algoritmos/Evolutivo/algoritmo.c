...
// Preenche uma estrutura com os progenitores da proxima geracao, de acordo com o resultados do torneio binario
...
void tournament(pchrom pop, int popsize, pchrom parents)
{
    ...
    for (int i = 0; i < popsize; i++)
    {
        ...
        // Seleciona o vencedor do torneio para ser progenitor da proxima geracao
        if (pop[x1].fitness < pop[x2].fitness) // problema mninimizacao
        {
            parents[i] = pop[x1];
        }
        else
